...
To update the database use this command from the Web project folder (replace `My.ProjectName` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../My.ProjectName.Infrastructure/My.ProjectName.Infrastructure.csproj -s My.ProjectName.Web.csproj
```
