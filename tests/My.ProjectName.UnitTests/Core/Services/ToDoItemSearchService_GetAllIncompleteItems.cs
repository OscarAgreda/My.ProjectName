...
using My.ProjectName.Core.ProjectAggregate;
using My.ProjectName.Core.Services;
using My.ProjectName.SharedKernel.Interfaces;
using Moq;
using Xunit;

namespace My.ProjectName.UnitTests.Core.Services
{
